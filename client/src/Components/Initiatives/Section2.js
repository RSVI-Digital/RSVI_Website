      ...
      <Container className={style.mainTraining}>
        ...
        <div className={style.container2} id="containerCard2">
          ...
          <Row className={style.Row4}>
            <Col className={style.containertext}>
              ...
              <p>
                {" "}
                Mobile Training is imparted at RSVI to the visually Impaired so
                that they can study and communicate through smart phones ,
                further impart training to other Visually Impaired students.{" "}
              </p>
              <input
                type="button"
                className={style.Dprevious}
                value="Previous"
                id="prev-btn_2"
        ...
        <div className={style.container3} id="containerCard3">
          <Row className={style.Row1}>
            ...
            <Col className={style.containertext}>
              <h2 className={style.containerH2}>
                {" "}
                Technical / Reading Without Seeing Training{" "}
              </h2>
              <p>
                {" "}
                Reading without seeing & Technological workshops are held at
                RSVI to aware Visually Impaired Persons about technology and new
                updations.{" "}
              </p>
            </Col>
          </Row>
